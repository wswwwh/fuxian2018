"""Export the accepted Figure 5.13 Lissajous stable-manifold transfer arc."""
...
from qp_orbits.quasi_torus import _trigonometric_interpolation_matrix, corrected_l1_vertical_lissajous_torus  # noqa: E402
...
SCAN = ROOT / "data" / "computed" / "chapter5_sun_earth_l1_lissajous_stable_manifold_scan.csv"
TRAJECTORY = ROOT / "data" / "computed" / "chapter5_sun_earth_l1_lissajous_leo_transfer.csv"
AUDIT = ROOT / "data" / "computed" / "chapter5_sun_earth_l1_lissajous_leo_transfer_audit.csv"
REPORT = ROOT / "docs" / "chapter5_sun_earth_l1_lissajous_leo_transfer_audit.md"
...
def main() -> None:
    ...
    states = np.empty_like(torus.correction.corrected_states)
    ...
    audit = {
        "figure_id": "5.14",
        "source_model": "Sun-Earth L1 corrected Lissajous DG stable-manifold transfer",
    ...
    REPORT.write_text(
        f"""# Chapter 5 Lissajous-to-LEO transfer audit
...
The trajectory is the high-resolution repropagation of the accepted two-angle
stable-manifold candidate from Figure 5.13. It replaces the analytic transfer
curve previously used by Figure 5.14. Ephemeris/BCR4BP correction remains a
separate high-fidelity boundary.
""",
        encoding="utf-8",
    )
    print(AUDIT)
