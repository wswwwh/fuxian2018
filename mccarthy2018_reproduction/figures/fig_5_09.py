...
def main() -> None:
    ...
    fig = plt.figure(figsize=(4.6, 5.8), constrained_layout=True)
    ax = fig.add_subplot(111, projection="3d")
    plot_surface(ax, baseline.corridor_surface, alpha=0.45)
    ...
    ax.text2D(0.12, 0.86, "Departure\nNRHO", transform=ax.transAxes, fontsize=9)
    ax.text2D(0.58, 0.88, "Destination\nNRHO", transform=ax.transAxes, fontsize=9)
