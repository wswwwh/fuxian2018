...
NOTES = "Corrected local DG sheet and numerical periodic-halo comparison; thesis Earthward reach/topology is not matched."
...
def main() -> None:
    ...
    fig.suptitle(
        "Local numerical manifold only; thesis Earthward reach/topology not reproduced",
        fontsize=9,
        color="#8a4b08",
    )
