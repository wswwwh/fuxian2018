...
当前检查点（成员 306）为：全曲面 `max|y|=849,057.381 km`、`max|z|=940,015.422 km`，y 目标误差 `+189,057.381 km`，z 目标误差 `+15.422 km`，Jacobi span `2.450e-10`，闭合残差 `5.874e-10`，网格 `129 x 256`。z 仍在目标附近，但 y 目标和最终 `target_pair_accepted` 仍未完成。
