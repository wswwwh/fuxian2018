...
当前检查点（成员 297）为：全曲面 `max|y|=872,303.382 km`、`max|z|=939,996.372 km`，y 目标误差 `+212,303.382 km`，Jacobi span `3.938e-10`，闭合残差 `2.106e-9`，网格 `129 x 256`。z 目标已达到，但 y 目标和最终 `target_pair_accepted` 仍未完成。
