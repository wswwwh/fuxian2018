...
当前检查点（成员 301）为：全曲面 `max|y|=861,887.892 km`、`max|z|=940,008.588 km`，y 目标误差 `+201,887.892 km`，z 目标误差 `+8.588 km`，Jacobi span `3.191e-10`，闭合残差 `3.032e-10`，网格 `129 x 256`。z 仍在目标附近，但 y 目标和最终 `target_pair_accepted` 仍未完成。
