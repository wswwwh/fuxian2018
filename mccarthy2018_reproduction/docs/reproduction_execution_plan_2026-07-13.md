...
当前检查点（成员 329）为：全曲面 `max|y|=811,069.907 km`、`max|z|=939,962.003 km`，y 目标误差 `+151,069.907 km`，z 目标误差 `-37.997 km`，Jacobi span `8.633e-11`，闭合残差 `8.136e-09`，网格 `129 x 256`。第 329 步在 `+8e-8` 偏置和 `1.8e-3` 步长下通过；闭合残差仍接近门槛，后续保持该保守上限，z 仍在目标附近，但 y 目标和最终 `target_pair_accepted` 仍未完成。
