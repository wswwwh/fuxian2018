...
- Accepted family members: `244`
- Last relative y-event step: `2.857e-03`
- Combined metric: `5.929e-09`
- Full-torus max |y|: `1022862.444` km
- Full-torus max |z|: `945560.790` km
- Event-grid max |y|: `1022864.474` km
- Event-grid max |z|: `945403.560` km
- Event-to-full y gap: `-2.030` km
- Event-to-full z gap: `+157.231` km
- Jacobi span: `5.917e-09`
- Closure residual: `4.138e-09`
- z target error: `+5560.790` km
...
- Last tangent-predictor scale: `2.690e+00`
...
- Last full-torus z-progress fraction: `0.540`
- Active Jacobi target: `3.000709223955017`
- Batch Jacobi-target change: `+2.561e-07`
- Per-member Jacobi-target offset: `+2.650e-07`
