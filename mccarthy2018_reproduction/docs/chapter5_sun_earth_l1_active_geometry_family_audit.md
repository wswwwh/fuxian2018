...
- Accepted family members: `249`
- Last relative y-event step: `2.857e-03`
- Combined metric: `1.065e-09`
- Full-torus max |y|: `1007610.753` km
- Full-torus max |z|: `944021.295` km
- Event-grid max |y|: `1007613.316` km
- Event-grid max |z|: `943903.582` km
- Event-to-full y gap: `-2.564` km
- Event-to-full z gap: `+117.713` km
- Jacobi span: `4.339e-09`
- Closure residual: `4.289e-11`
- z target error: `+4021.295` km
...
- Last full-torus z-progress fraction: `1.023`
- Active Jacobi target: `3.000710636238682`
- Batch Jacobi-target change: `+8.417e-07`
