...
- `C5-UPSTREAM-CHAPTER4-SOURCE`: status `pass`, metric `fig_4_route_h_png_bytes` = `345125`, decision `route_h_chapter4_source_available`
- `C5-ROUTE-H-DE421-BASELINE`: status `pass`, metric `fig_5_6_png_bytes` = `588057`, decision `route_h_de421_baseline_available`
