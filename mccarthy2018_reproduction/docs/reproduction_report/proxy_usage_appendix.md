...
- Fig. 4.1: `shape-match with corrected DG numerical overlay`; proxy flag `partial`; PNG bytes 304877; PDF bytes 71095; boundary: Current DG spectrum is corrected numerical evidence, but display scaling and original raw thesis branch data remain unavailable.
