...
branch for Fig. 3.16 / Fig. 3.17 now reaches `14573.10318409037` km with
...
validation table has `30` rows, best max abs z
`14573.10318409037` km, max map residual `6.469474407020314e-10`,
and max one-map Jacobi drift `7.760059261840979e-11`.
...
Static camera anchors pass `16/16`,
