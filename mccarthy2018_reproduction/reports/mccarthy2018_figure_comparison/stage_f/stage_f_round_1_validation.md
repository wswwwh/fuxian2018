# stage_f_round_1 报告自动审计

- 状态：**FAIL**
- 生成时间：`2026-07-15T15:28:13.345811+00:00`
...
| 28 个核心量化表进入 DOCX/PDF | FAIL | `{"docx": 54, "pdf": 54}` |
| 54 个逐图等级与证据状态叙述 | PASS | `{"grade_narratives": 54, "status_mentions": 55}` |
| 核心数值图 28 张且指标完整 | PASS | `{"core_ids": 28, "failures": []}` |
| 自动目录字段存在 | PASS | `"TOC \\h \\o \"1-3\"  HYPERLINK \\l _Toc22429   PAGEREF _Toc22429 \\h   HYPERLINK \\l _Toc2513   PAGEREF _Toc2513 \\h   HYPERLINK \\l _Toc31821   PAGEREF _Toc31821 \\h   HYPERLINK \\l _Toc260   PAGEREF _Toc260 \\h   HYPERLINK \\l _Toc14350   PAGEREF _Toc143...` |
| 页码字段存在 | PASS | `true` |
| 标题自动编号存在 | PASS | `70` |
...
| 参考文献与正文引用存在 | FAIL | `{"citation_1": 1}` |
| 关键单位进入报告 | PASS | `{"km": 152, "day": 141, "m/s": 32}` |
| 可重复构建命令进入附录 | PASS | `true` |
| 多级标题编号后保留空格 | FAIL | `{"joined_heading_count": 19, "examples": ["4.10McCarthy Fig.", "4.11McCarthy Fig.", "4.12McCarthy Fig.", "4.13McCarthy Fig.", "4.14McCarthy Fig."]}` |
| PDF 无真正空白页 | PASS | `[]` |
| PDF 无近空白孤页 | PASS | `[]` |
